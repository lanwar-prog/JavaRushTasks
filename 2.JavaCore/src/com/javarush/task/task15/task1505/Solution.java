...
5. Метод containsBones() в классе Finger должен возвращать строку "Yes", если такой же метод
в классе BodyPart возвращает "Yes" и флаг isArtificial равен false. Если приведенное условие не выполняется - вернуть "No".
6. Метод toString() в классе BodyPart должен возвращать строку формата "name(имя части тела)
содержит кости", если метод containsBones() возвращает "Yes" для этой части тела. Если "No",

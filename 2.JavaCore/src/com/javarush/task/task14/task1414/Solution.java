...
5. Метод main должен прекращать считывать строки с клавиатуры, если была введена некорректная строка (не "cartoon",
не "thriller" или не "soapOpera").
...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        for (String next: list) {
            ...
            Movie movie = MovieFactory.getMovie(next);
            if (movie != null) {

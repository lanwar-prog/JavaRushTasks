...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for (Apartment next : apartments) {
            if (next instanceof OneRoomApt) {
                  ((OneRoomApt) next).clean1Room();
            }else if (next instanceof TwoRoomApt) {
                ((TwoRoomApt) next).clean2Rooms();
            }else if (next instanceof ThreeRoomApt) {
                ((ThreeRoomApt) next).clean3Rooms();
            }
